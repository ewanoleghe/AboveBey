<template>
    <Head title=" | Make BLS/CPR/AED CLass" />
    <div class="bg-lime-300 text-center mb-3 -mt-3">
        <h1 class="text-3xl font-bold p-6">Add BLS/CPR/AED Training Courses</h1>
        ...
        <div class="flex flex-wrap mx-2 justify-center">
            ...
            <div class="flex-none w-full md:w-1/12 mb-2 md:mb-4 p-4 rounded-lg min-w-[220px]">
                <h1 class="text-2xl font-bold">{{ "Add BLS/CPR/AED Training" }} </h1>
            </div>
            <div class="flex-none w-full md:w-3/6 mb-2 md:mb-4 p-4 mx-2 bg-orange-300 rounded-lg shadow-md min-w-[220px]">
                ...
                <div class="flex flex-col md:flex-row justify-center space-x-0 md:space-x-4 h-full">
                    <div class="w-full md:w-3/3 bg-gray-200 flex flex-col justify-between mb-4 md:mb-0">
                        <img class="w-full h-72 object-cover"  :src="cna_group"  alt="BLS/CPR/AED" />
                        <div class="p-4 flex-grow">
                            <h2 class="text-xl font-bold">{{ "Add BLS/CPR/AED Training" }}</h2> 
                            <hr class="border-t-2 border-black mb-4">
                            <h2 class="text-2xl font-bold justify-center text-center p-4">Create a New BLS/CPR/AED Programm</h2>
                            <p class="justify-center mb-4 mt-2 text-xl pb-5">
                                Please fill in your details in this Form below to Create a Training Program.<br>
                            </p>
                                ...
                                <table class="mt-1 text-x text-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right pb-6" colspan="2">{{ "Basic Life Support" }}</td>
                                        </tr>
                                        <tr>
                                            <td class="text-left pb-4" colspan="1">Class Code</td>
                                            <td class="text-right pb-4" colspan="2">{{ "Basic Life Support/AED-BL-r.21" }}</td>
                                        </tr>
...
const submit = () => {
    ...
    form.post(route('SubmitRegisterBlsClass'), {
