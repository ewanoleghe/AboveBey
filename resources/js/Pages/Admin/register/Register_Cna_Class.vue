<template>
    <Head title=" | Make CNA CLass" />
    <div class="bg-lime-300 text-center mb-3 -mt-3">
        <h1 class="text-3xl font-bold p-6">Add CNA Training Courses</h1>
        ...
        <div class="flex flex-wrap mx-2 justify-center">
            ...
            <div class="flex-none w-full md:w-1/12 mb-2 md:mb-4 p-4 rounded-lg min-w-[220px]">
                <h1 class="text-2xl font-bold">{{ "Add CNA Training" }} </h1>
            </div>
                ...
                <div class="flex flex-col md:flex-row justify-center space-x-0 md:space-x-4 h-full">
                    <div class="w-full md:w-3/3 bg-gray-200 flex flex-col justify-between mb-4 md:mb-0">
                        ...
                        <div class="p-4 flex-grow">
                            <h2 class="text-xl font-bold">{{ "Add CNA Training" }}</h2> 
                            <hr class="border-t-2 border-black mb-4">
                            <h2 class="text-2xl font-bold justify-center text-center p-4">Create a New CNA Programm</h2>
                            ...
                            <form @submit.prevent="submit" class="flex flex-wrap mt-5">
                                ...
                                <button 
                                    ...
                                    >
                                        ...
                                        <span v-if="form.processing" class="ml-8">Creating New CNA Class...</span>
                                    </button>
                                ...
                                <table class="mt-1 text-x text-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right pb-6" colspan="2">{{ "NURSE AIDE/ASSISTANT" }}</td>
                                        </tr>
                                        <tr>
                                            <td class="text-left pb-4" colspan="1">Class Code</td>
                                            <td class="text-right pb-4" colspan="2">{{ "Adult and Pediatric First Aid/CPR/AED-BL-r.21" }}</td>
                                        </tr>
...
const submit = () => {
    ...
    form.post(route('SubmitRegisterCnaClass'), {
