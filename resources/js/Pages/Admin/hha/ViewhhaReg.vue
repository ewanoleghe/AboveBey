    ...
    <div class="flex flex-wrap mx-2 mb-4 justify-center">
        ...
        <div class="flex flex-wrap mx-2 justify-center">
            ...
            <div class="flex-none w-full md:w-1/12 mb-2 md:mb-4 p-4 rounded-lg min-w-[220px] no-print">
                <h1 class="text-xl font-bold">{{ "HHA" }}<br>{{ "Registration" }}</h1>                <!-- Print Button -->
                ...
                <div class="flex flex-col md:flex-row justify-center space-x-0 md:space-x-4 h-full">
                    <div class="w-full md:w-3/3 bg-lime-300 flex flex-col justify-between mb-4 md:mb-0">
                        <div class="p-4 flex-grow">
                            <h2 class="text-xl font-bold">HHA Enrollment</h2> 
                                ...
                                <table class="min-w-full bg-white border border-gray-300">
                                    <thead>
                                        <tr class="bg-gray-200">
                                            <th class="px-4 py-2 text-left text-3xl" colspan="2">{{ hhaApplication.first_name }} {{ hhaApplication.last_name }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td class="border px-4 py-2 text-left font-bold">First Name</td>
                                            <td class="border px-4 py-2 font-bold">{{ hhaApplication.first_name }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border px-4 py-2 text-left font-bold">Last Name</td>
                                            <td class="border px-4 py-2 font-bold">{{ hhaApplication.last_name }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border px-4 py-2 text-left font-bold">SSN</td>
                                            <td class="border px-4 py-2 font-bold">{{ hhaApplication.ssn }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border px-4 py-2 text-left font-bold">Email</td>
                                            <td class="border px-4 py-2 font-bold">{{ hhaApplication.email }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border px-4 py-2 text-left font-bold">Phone Number</td>
                                            <td class="border px-4 py-2 font-bold">{{ hhaApplication.phone }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border px-4 py-2 text-left font-bold">Address</td>
                                            <td class="border px-4 py-2 font-bold">{{ hhaApplication.address }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border px-4 py-2 text-left font-bold">City</td>
                                            <td class="border px-4 py-2 font-bold">{{ hhaApplication.city }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border px-4 py-2 text-left font-bold">County</td>
                                            <td class="border px-4 py-2 font-bold">{{ hhaApplication.county }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border px-4 py-2 text-left font-bold">Post Code</td>
                                            <td class="border px-4 py-2 font-bold">{{ hhaApplication.postcode }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border px-4 py-2 text-left font-bold">Signature</td>
                                            <td class="border px-4 py-2 font-bold">{{ hhaApplication.signature }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="p-4 flex-grow">
                            ...
                            <div class="pt-3">
                                <table class="min-w-full bg-white border border-gray-300">
                                    <thead>
                                        <tr class="bg-gray-200">
                                            <th class="px-4 py-2 text-left text-3xl" colspan="2">{{ hhaApplication.program_name }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td class="border px-4 py-2 text-left font-bold">Program ID</td>
                                            <td class="border px-4 py-2 font-bold">{{ hhaApplication.cna_class_id }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border px-4 py-2 text-left font-bold">Program Name</td>
                                            <td class="border px-4 py-2 font-bold">{{ hhaApplication.program_name }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border px-4 py-2 text-left font-bold">Training Code</td>
                                            <td class="border px-4 py-2 font-bold">{{ hhaApplication.training_code }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border px-4 py-2 text-left font-bold">Class Type</td>
                                            <td class="border px-4 py-2 font-bold">{{ hhaApplication.class_type }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border px-4 py-2 text-left font-bold">Start Date - End Date</td>
                                            <td class="border px-4 py-2 font-bold">{{ getDate(hhaApplication.course_start) }} - {{ getDate(hhaApplication.course_end) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border px-4 py-2 text-left font-bold">Time</td>
                                            <td class="border px-4 py-2 font-bold">{{ formatTime(hhaApplication.time_start) }} - {{ formatTime(hhaApplication.time_end) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border px-4 py-2 text-left font-bold">Application Fee</td>
                                            <td class="border px-4 py-2 font-bold">${{ hhaApplication.application_fee }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border px-4 py-2 text-left font-bold">Payment Status</td>
                                            <td class="border px-4 py-2 font-bold">{{ hhaApplication.payment_status }}</td>
                                        </tr>
                                        <tr>
                                            <td  colspan="2"
                                                :class="[hhaApplication.payment_status === 'paid' ? 'bg-red-400' : 'bg-lime-300', 
                                                        'text-black', 'text-center', 'font-bold', 'text-xl', 'p-2']">
                                                <button 
                                                    @click="updatePaymentStatus(hhaApplication.id)"
                                                    class="text-black no-print">
                                                    {{ hhaApplication.payment_status === 'paid' ? 'Set Pending' : 'Set Paid' }}
                                                </button>
                                            </td>
                                        </tr>
                                    </tbody>
...
const updatePaymentStatus = async (id) => {
    try {
        ...
        await router.patch('/admin/update_hha_payment_status', { id }, { preserveScroll: true });
    } catch (error) {
