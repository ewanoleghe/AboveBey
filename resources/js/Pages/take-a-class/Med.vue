    ...
    <div class="bg-lime-300 text-center mb-3 -mt-3">
        ...
        <div class="flex flex-wrap mx-2 justify-center">
            ...
            <div class="flex-none w-full md:w-1/12 mb-2 md:mb-4 p-4 rounded-lg min-w-[220px]">
                <h1 class="text-2xl font-bold">{{ 'Medication' }}<br>{{ 'Administration' }}<br><br>{{ 'CMA' }}<br>{{ 'Training' }}</h1>
            </div>
            <!-- column 2 -->
                ...
                <div class="flex flex-col md:flex-row justify-center space-x-0 md:space-x-4 h-full">
                    <div class="w-full md:w-6/6 bg-gray-200 flex flex-col justify-between mb-4 md:mb-0">
                        ...
                        <div class="p-4 flex-grow">
                            <h2 class="text-xl font-bold">MEDICATION ADMINISTRATION TRAINING (CMA)</h2> 
                            <hr class="border-t-2 border-black">
                            <h2 class="text-xl font-bold my-5">CMA Training Dates</h2> 
                            ...
                            <div class="overflow-x-auto p-2">
                                    ...
                                    <tbody>
                                        ...
                                        <tr v-for="classes in takeMedclass.data" :key="classes.id">
                                            ...
                                            <td class="bg-orange-300 text-black text-center font-bold border p-2 border-black">
                                                <Link :href="`/take-a-class/med/training.application?id=${classes.id}`" class="text-black">
                                                    Sign me up &#129195;
                                                </Link>
                                            </td>
                                ...
                                <div>
                                    ...
                                    <PaginationLinks :paginator="takeMedclass" />
                                </div>
                            </div>
