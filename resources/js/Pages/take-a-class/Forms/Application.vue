    ...
    <div class="bg-lime-300 text-center mb-3 -mt-3">
        ...
        <div class="flex flex-wrap mx-2 justify-center">
            ...
            <div class="flex-none w-full md:w-1/12 mb-2 md:mb-4 p-4 rounded-lg min-w-[220px]">
                <h1 class="text-2xl font-bold">{{ cnaClass.program_name }} </h1>
            </div>
            <!-- column 2 -->
                ...
                <div class="flex flex-col md:flex-row justify-center space-x-0 md:space-x-4 h-full">
                    <div class="w-full md:w-3/3 bg-lime-300 flex flex-col justify-between mb-4 md:mb-0">
                        ...
                        <div class="p-4 flex-grow">
                            <h2 class="text-xl font-bold">{{ cnaClass.program_name }}</h2> 
                    ...
                    <div class="w-full md:w-3/3 bg-orange-300 flex flex-col justify-between mb-4 md:mb-0">
                        ...
                        <div class="p-4 flex-grow">
                            ...
                            <p class="text-center text-x mb-4 pb-4 ">
                                {{ cnaClass.program_name }} Program Summary
                            </p>
                            <div class="flex flex-wrap flex-col w-full mb-2 md:mb-2 p-2 bg-white rounded-lg shadow-md min-w-[220px]">
                                <table class="mt-1 text-x text-sm">
                                    <thead>
                                        <tr>
                                            <th class="text-left pb-2" colspan="3">{{ cnaClass.training_code }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td class="text-left pb-2"  colspan="1">Classroom</td>
                                            <th class="text-right pb-2"  colspan="2">{{ cnaClass.class_type }}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right pb-2" colspan="2">{{ formatCnaDate(cnaClass.course_start) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="text-left pb-2" colspan="1">End</td>
                                            <td class="text-right pb-2" colspan="2">{{ formatCnaDate(cnaClass.course_end) }}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right pb-2" colspan="2">{{ formatCnaTime(cnaClass.time_start) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="text-left pb-2" colspan="1">End Time</td>
                                            <td class="text-right pb-2" colspan="2">{{ formatCnaTime(cnaClass.time_end) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="text-left pb-2 pt-8" colspan="1">*Application Fee</td>
                                            <th class="text-right pb-2 pt-8" colspan="2">{{ cnaClass.application_fee }}</th>
                                        </tr>
                                    </tbody>
                                </table>
...
const form = useForm({
    ...
    cna_class_id: String(props.cnaClass.id), // Convert to string   
    program_name: String(props.cnaClass.program_name),
    training_code: String(props.cnaClass.training_code),
    class_type: String(props.cnaClass.class_type),
    course_start: String(props.cnaClass.course_start),
    course_end: String(props.cnaClass.course_end),
    time_start: String(props.cnaClass.time_start),
    time_end: String(props.cnaClass.time_end),
    application_fee: String(props.cnaClass.application_fee),
