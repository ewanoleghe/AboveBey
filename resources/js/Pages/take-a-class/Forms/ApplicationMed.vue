<template>
    ...
    <div class="bg-lime-300 text-center mb-3 -mt-3">
        <h1 class="text-3xl font-bold p-6">Medication Administration (CMA) Training Courses</h1>
        ...
        <div class="flex flex-wrap mx-2 justify-center">
            ...
            <div class="flex-none w-full md:w-1/12 mb-2 md:mb-4 p-4 rounded-lg min-w-[220px]">
                <h1 class="text-2xl font-bold">{{ MedClass.program_name }} </h1>
            </div>
            <!-- column 2 -->
                ...
                <div class="flex flex-col md:flex-row justify-center space-x-0 md:space-x-4 h-full">
                    <div class="w-full md:w-3/3 bg-gray-200 flex flex-col justify-between mb-4 md:mb-0">
                        ...
                        <div class="p-4 flex-grow">
                            <h2 class="text-xl font-bold">{{ MedClass.program_name }}</h2> 
                    ...
                    <div class="w-full md:w-3/3 bg-lime-300 flex flex-col justify-between mb-4 md:mb-0">
                        ...
                        <div class="p-4 flex-grow">
                            ...
                            <p class="text-center text-x mb-4 pb-4 ">
                                {{ MedClass.program_name }} Program Summary
                            </p>
                            <div class="flex flex-wrap flex-col w-full mb-2 md:mb-2 p-2 bg-white rounded-lg shadow-md min-w-[220px]">
                                <table class="mt-1 text-x text-sm">
                                    <thead>
                                        <tr>
                                            <th class="text-left pb-2" colspan="3">{{ MedClass.training_code }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td class="text-left pb-2"  colspan="1">Classroom</td>
                                            <th class="text-right pb-2"  colspan="2">{{ MedClass.class_type }}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right pb-2" colspan="2">{{ formatCnaDate(MedClass.course_start) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="text-left pb-2" colspan="1">End</td>
                                            <td class="text-right pb-2" colspan="2">{{ formatCnaDate(MedClass.course_end) }}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right pb-2" colspan="2">{{ formatCnaTime(MedClass.time_start) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="text-left pb-2" colspan="1">End Time</td>
                                            <td class="text-right pb-2" colspan="2">{{ formatCnaTime(MedClass.time_end) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="text-left pb-2 pt-8" colspan="1">*Application Fee</td>
                                            <th class="text-right pb-2 pt-8" colspan="2">{{ MedClass.application_fee }}</th>
                                        </tr>
                                    </tbody>
                                </table>
...
const form = useForm({
    ...
    cna_class_id: String(props.MedClass.id), // Convert to string   
    program_name: String(props.MedClass.program_name),
    training_code: String(props.MedClass.training_code),
    class_type: String(props.MedClass.class_type),
    course_start: String(props.MedClass.course_start),
    course_end: String(props.MedClass.course_end),
    time_start: String(props.MedClass.time_start),
    time_end: String(props.MedClass.time_end),
    application_fee: String(props.MedClass.application_fee),
